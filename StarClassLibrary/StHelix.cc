/***************************************************************************
 *
 * $Id: StHelix.cc,v 1.1 2010/10/28 16:59:35 dongx Exp $
 *
 ...
 *
 * $Log: StHelix.cc,v $
 * Revision 1.1  2010/10/28 16:59:35  dongx
...
StHelix::pathLengths(const StHelix& h) const
{
	...
	// 
	const double MinStepSize = 500*micrometer;
	const double MinRange    = 10*centimeter;    
	double dmin              = h.distance(at(s));
	
	if(dmin > 5.) {
	  return pair<double,double>(-999999.,-999999.);
	}
