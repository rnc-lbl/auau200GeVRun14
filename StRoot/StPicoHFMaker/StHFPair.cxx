  ...
  mDcaDaughters(std::numeric_limits<unsigned short>::max()), mCosThetaStar(std::numeric_limits<char>::min())
{
   ...
   StLorentzVectorF const p1FourMom(p1MomAtDca, kMomAtDca.massHypothesis(mParticle1MassHypo));
   StLorentzVectorF const p2FourMom(p2MomAtDca, pMomAtDca.massHypothesis(mParticle2MassHypo));
